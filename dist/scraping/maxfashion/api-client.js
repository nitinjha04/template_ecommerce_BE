...
exports.fetchProductPool = exports.fetchCatalogCount = exports.fetchCategoryPage = exports.buildCategoryUrl = void 0;
...
const buildCategoryUrl = (params) => {
    ...
    return `${constants_1.UNBXD_CATEGORY_URL}?${search.toString()}`;
};
exports.buildCategoryUrl = buildCategoryUrl;
const fetchCategoryPage = async (params, retries = 3) => {
    const url = (0, exports.buildCategoryUrl)(params);
    let lastError = null;
    ...
    throw lastError ?? new Error('Unbxd category fetch failed');
};
