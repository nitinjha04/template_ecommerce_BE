...
exports.sanitizeScrapedProduct = exports.replaceEmpressWithCasaq = void 0;
...
const replaceEmpressWithCasaq = (text) => text.replace(EMPRESS_PATTERN, casaqForMatch);
exports.replaceEmpressWithCasaq = replaceEmpressWithCasaq;
const sanitizeString = (value) => (0, exports.replaceEmpressWithCasaq)(value);
