...
exports.productImageKeys = exports.mapNexaToProductDocument = exports.buildNexaSlug = exports.collectNexaColors = exports.collectNexaSizes = exports.collectNexaImages = void 0;
...
exports.collectNexaImages = collectNexaImages;
const collectNexaSizes = (raw) => {
    const sizes = new Set();
...
exports.collectNexaSizes = collectNexaSizes;
const collectNexaColors = (raw) => {
...
exports.collectNexaColors = collectNexaColors;
const buildNexaSlug = (raw) => {
...
exports.buildNexaSlug = buildNexaSlug;
const toV2Shim = (raw, assignedPrice) => {
    ...
    return {
        ...
        availableSizes: (0, exports.collectNexaSizes)(raw),
        totalStock: raw.inStock === 0 ? 0 : undefined,
        isSoldOut: raw.inStock === 0,
    };
};
const mapNexaToProductDocument = (raw, options) => {
    const name = raw.name?.trim();
    if (!name)
        return null;
    const images = (0, exports.collectNexaImages)(raw);
    if (images.length === 0)
        return null;
    ...
    const slug = (0, exports.buildNexaSlug)(raw);
    ...
    const doc = {
        ...
        sizes: (0, exports.collectNexaSizes)(raw),
        colors: (0, exports.collectNexaColors)(raw),
        images,
...
exports.mapNexaToProductDocument = mapNexaToProductDocument;
const productImageKeys = (raw) => (0, exports.collectNexaImages)(raw).map((url) => (0, image_utils_1.imageDedupeKey)(url));
