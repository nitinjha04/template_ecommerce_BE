...
exports.signupWelcomeEmail = void 0;
const signupWelcomeEmail = (name, shopUrl, brandName) => ({
    ...
    <div style="font-family: Arial, sans-serif; max-width: 520px; margin: 0 auto; line-height: 1.6; color: #333;">
      ...
      <p>Your email has been verified and your ${brandName} account is now active.</p>
      ...
      <p style="color: #666; font-size: 13px; margin-top: 32px;">Thank you for joining ${brandName}.</p>
    </div>
  `,
});
exports.signupWelcomeEmail = signupWelcomeEmail;
